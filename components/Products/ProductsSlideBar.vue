...
<aside  class="fixed top-1/12 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base  transition duration-75 rounded-lg group  text-white hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  <svg class="flex-shrink-0 w-5 h-5  transition duration-75  text-gray-400 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="#" class="flex items-center w-full p-2 git *:transition duration-75 rounded-lg pl-11 group text-white hover:bg-gray-700">Invoice</a>
                  </li>
            </ul>
         </li>
