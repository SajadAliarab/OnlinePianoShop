...
<template>
 <UCarousel v-slot="{ item }" :items="slideData"  class="w-screen h-auto overflow-hidden p-5 " indicators arrows>

    <img :src="item.image" class=" w-screen h-auto" draggable="true">
